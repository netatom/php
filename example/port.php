...
echo '<form action="' .$_SERVER["PHP_SELF"]. '" method="get">
  <div style="width:300px;background:#f1f1f1;padding:10px;font-family:arial;">
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td width="30%" style="font-size:12px;">Begin Port Number</td>
        <td width="80%"><input type="text" name="port" value="' .$port. '"></td>
      </tr>
      <tr>
        <td width="30%" style="font-size:12px;">End Pprt Number</td>
...
<?php
$value =explode(' ' , $p_open);
$var=1;
while($var<count($value)) {
	echo "
	<tr>
		<td>
